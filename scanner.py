...
if __name__ == "__main__":
  print("BIST Tarama başlatılıyor (Paralel / Eş Zamanlı)...")

  aktif_periyotlar = [p for p, aktif in TARAMA_YAPILACAK_PERIYOTLAR.items() if aktif]
  tasks = [(ticker, periyot) for periyot in aktif_periyotlar for ticker in tickers]

  with ThreadPoolExecutor(max_workers=20) as executor:
    executor.map(analyze_target, tasks)
